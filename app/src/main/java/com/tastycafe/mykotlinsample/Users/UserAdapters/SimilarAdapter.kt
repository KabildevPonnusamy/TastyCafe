...
class SimilarAdapter(var context: Context, val cateitemslist: ArrayList<ItemDatasList>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent?.context).inflate(R.layout.user_similar_childs, parent, false)
        return ViewHolder(v)
                }
