...
class OfferedUserItemsAdapter(var context: Context, val cateitemslist: ArrayList<ItemDatasList>) :
    RecyclerView.Adapter<OfferedUserItemsAdapter.ViewHolder> (){
